...
export const ACCESSOIRES_DEF = {
  ...
  "lunettes-soleil": { nom: "🕶️ Lunettes de soleil", svg: () => `<circle cx="37" cy="63" r="8.5" fill="#2d3436"/><circle cx="63" cy="63" r="8.5" fill="#2d3436"/><circle cx="34" cy="60" r="2.5" fill="#6c7a89" opacity="0.8"/><circle cx="60" cy="60" r="2.5" fill="#6c7a89" opacity="0.8"/><line x1="45.5" y1="63" x2="54.5" y2="63" stroke="#2d3436" stroke-width="2.5"/><line x1="28.5" y1="63" x2="22" y2="59" stroke="#2d3436" stroke-width="2.5"/><line x1="71.5" y1="63" x2="78" y2="59" stroke="#2d3436" stroke-width="2.5"/>` },
