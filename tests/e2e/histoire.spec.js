...
test.beforeEach(async ({ context }) => {
  await context.addInitScript(() => {
    ...
    localStorage.setItem("maths-cp-niveau", "cm1");
...
test("le jeu Histoire est jouable depuis le menu", async ({ page }) => {
  ...
  await page.locator('.carte-jeu[data-jeu="histoire"]').click();
